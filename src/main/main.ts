...
import { registerUIPreferencesHandlers } from './ipc/ui-preferences-handlers';
...
// Register UI preferences handlers (no mainWindow needed)
registerUIPreferencesHandlers();
